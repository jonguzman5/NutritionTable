...
INSERT INTO tenants (id, name, age, gender, apartment_id) VALUES (2, 'Jonathan Guzman', 74, 'Male', 1);
...
SELECT tenants.* , apartments.price FROM tenants, apartments WHERE tenants.apartment_id = apartments.id AND apartments.price>2300;
